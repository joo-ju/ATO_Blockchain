...
docker exec cli peer chaincode invoke -o orderer.ato.com:7050 -C channelseller -n ato-cc -c '{"function":"setGoods", "Args":["Fabric", "State", "Hyper", "Category", "20", "Content", "1Q2W3E4R"]}'
sleep 3

# query chaincode for channelseller
docker exec cli peer chaincode query -o orderer.ato.com:7050 -C channelsseller -n ato-cc -c '{"function":"getAllGoods","Args":[""]}'
