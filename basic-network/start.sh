...
# docker-compose up -d
docker-compose -f docker-compose.yaml up -d orderer1.ato.com peer0.seller.ato.com peer1.seller.ato.com peer0.buyer.ato.com peer1.buyer.ato.com cli
...
# Create the channel
docker exec cli peer channel create -o orderer1.ato.com:7050 -c channelseller -f /etc/hyperledger/configtx/channel1.tx
...
docker exec cli peer channel update -o orderer1.ato.com:7050 -c channelseller -f /etc/hyperledger/configtx/SellerOrganchors.tx
